...
function Run-Category {
  ...
  switch ($Category) {
    ...
    'XUnitMTP' {
      ...
      # Use the explicit perTest config so CI exercises the MTP live per-test coverage capture
      # path (epoch-based attribution with process reuse) end-to-end, not just locally.
